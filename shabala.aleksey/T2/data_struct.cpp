...
std::istream & shabala::operator>>(std::istream &is, DataStruct &value)
{
...
std::ostream & shabala::operator<<(std::ostream & out, const DataStruct &value)
{
...
bool shabala::operator>(const DataStruct &left, const DataStruct &right)
{
